...
char ssid[] = "emed@17vnpuri";        
char pass[] = "D17vnpuri";   

WiFiClient client;

// Open Weather Map API server name
const char server[] = "35.154.55.24";

// Replace the next line to match your city and 2 letter country code
//String nameOfCity = "LUCKNOW,91"; 
...
//String apiKey = "63a193bd9665272707ac266eef3fd92f"; 
...
void makehttpRequest() {
  ...
  if (client.connect(server, 80)) {
    ...
    //client.println("GET /data/2.5/forecast?q + &mode=json&units=metric&cnt=2 HTTP/1.1");
    client.println("GET /data/1.0/aqi?lat=26.8718431&lon=80.9459051&APPID=qsfmma0bkgr296g79ogrhfubg5 + &mode=json&units=metric&cnt=2 HTTP/1.1");
    client.println("Host: 35.154.55.24");
